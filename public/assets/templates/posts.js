...
(function () {
  ...
  if (!__l) { return; }
    var _ctx__loopcache06817452027462423 = { loop: _ctx.loop, post: _ctx.post, __k: _ctx.__k };
...
_output += "</div>\n    </li>\n  ";
  ...
  _ctx.loop = _ctx__loopcache06817452027462423.loop;
  _ctx.post = _ctx__loopcache06817452027462423.post;
  _ctx.__k = _ctx__loopcache06817452027462423.__k;
  _ctx__loopcache06817452027462423 = undefined;
})();
_output += "\n</ul>";
