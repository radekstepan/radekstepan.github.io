...
(function () {
  ...
  if (!__l) { return; }
    var _ctx__loopcache06093211332336068 = { loop: _ctx.loop, post: _ctx.post, __k: _ctx.__k };
...
_output += "</div>\n    </li>\n  ";
  ...
  _ctx.loop = _ctx__loopcache06093211332336068.loop;
  _ctx.post = _ctx__loopcache06093211332336068.post;
  _ctx.__k = _ctx__loopcache06093211332336068.__k;
  _ctx__loopcache06093211332336068 = undefined;
})();
_output += "\n</ul>";
