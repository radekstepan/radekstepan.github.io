...
(function () {
  ...
  if (!__l) { return; }
    var _ctx__loopcache01621301374398172 = { loop: _ctx.loop, post: _ctx.post, __k: _ctx.__k };
...
_output += "</div>\n    </li>\n  ";
  ...
  _ctx.loop = _ctx__loopcache01621301374398172.loop;
  _ctx.post = _ctx__loopcache01621301374398172.post;
  _ctx.__k = _ctx__loopcache01621301374398172.__k;
  _ctx__loopcache01621301374398172 = undefined;
})();
_output += "\n</ul>";
